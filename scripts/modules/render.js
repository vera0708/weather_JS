import { convertPressure, getDewPoint, getWeatherForecastData, getWindDirection, getcurrentDataTime } from "./utils.js";

export const renderWidgetToday = (widget, data) => {

  const { dayOfMonths, month, year, hours, minutes, dayOfWeek, } = getcurrentDataTime();
  widget.insertAdjacentHTML(
    'beforeend',
    `        <div class="widget__today">
      <div class="widget__date-block">
        <p class="widget__date">${dayOfMonths} ${month} ${year}</p>
  ...
  widget.insertAdjacentHTML(
    ...
    `<div class="widget__other">
      ...
      <div class="widget__humidity">
        ...
        <p class="widget__humidity-text">Т.Р:${getDewPoint(data.main.temp, data.main.humidity)}°C</p>
      </div>
...
export const showError = (widget, error) => {
  ...
  widget.classList.add('widger_error')
}